...
You have to achieve two major tasks:
    ...
    Create a Login API in flask in this structure.
...
Make sure that all the api only logic should go in api layer (views.py) and all the business logic should go in the service layer (user_service.py).
